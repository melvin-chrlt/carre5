<aside
    ...
    ?>
            <li class="nav-item">
                <a class="nav-link  active" href="addOffers.php">
                    <div
...
if (!empty($_SESSION)) {
    ?>
                <!-- <a class="nav-link  " href="profile.php">
                    ...
                    <span class="nav-link-text ms-1"><?php echo $_SESSION["user"]; ?></span>
                </a> -->
                <a class="nav-link" href="?logout">
                    ...
                    <span class="nav-link-text ms-1" style="color:red;">Logout</span>
                </a>
                <?php
} else {
    ?>
...
?>
            ...
            <li class="nav-item">
                <a class="nav-link  " href="offers.php">
                    ...
                    <span class="nav-link-text ms-1">Show All Products</span>
                </a>
            </li>
    ...
    <div class="ps__rail-y" style="top: 0px; height: 568px; right: 0px;">
        <div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 486px;"></div>
    </div>
</aside>